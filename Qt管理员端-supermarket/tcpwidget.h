...
signals:
    ...
    void recv_menlist_singal(QString str);
...
private slots:
    ...
    /*发送请求卡号*/
     ...
     /*发送请求会员列表*/
     void send_request_memlist(void);

     /*发送请求商品列表*/
     void send_request_goodslist(void);

     /*发送请求保存会员列表*/
     void send_request_save_memlist(QString memlist);

     /*发送请求保存商品列表*/
     void send_request_save_goodslist(QString goodslist);
